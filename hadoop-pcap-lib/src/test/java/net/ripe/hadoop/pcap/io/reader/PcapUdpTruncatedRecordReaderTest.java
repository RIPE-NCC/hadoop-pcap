...
public class PcapUdpTruncatedRecordReaderTest {
	private static final Log LOG = LogFactory.getLog(PcapUdpTruncatedRecordReaderTest.class);

	private final File TEST_FILE = new File("src/test/resources/udp-length-zero.pcap");
